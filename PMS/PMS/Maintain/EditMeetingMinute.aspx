<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditMeetingMinute.aspx.cs"
    Inherits="PMS.PMS.Maintain.EditMeetingMinute" %>
...
<head id="Head1" runat="server">
    ...
    <base target="_self" />
    <title>Edit Meeting Minute</title>
            ...
            <div>
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:TextBox ID="TextBoxSubject" runat="server" CssClass="TextBoxLong" MaxLength="500" />
                        <br />
                        <br />
                        ...
                        <asp:TextBox ID="TextBoxAttendee" runat="server" CssClass="TextBoxLong" MaxLength="100" />
                        <br />
                        <br />
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="GridViewConclusion" runat="server" Width="664px" CssClass="DIVGrid"
                            ...
                            OnRowDataBound="GridViewConclusion_RowDataBound" OnRowDeleting="GridViewConclusion_RowDeleting"
                            OnRowEditing="GridViewConclusion_RowEditing" OnRowUpdating="GridViewConclusion_RowUpdating"
                            OnRowCancelingEdit="GridViewConclusion_RowCancelingEdit">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Serial">
                                    <ItemTemplate>
                                        <asp:Label ID="LabelSerial" runat="server" Width="100%" Text='<%#  DataBinder.Eval(Container.DataItem, "Serial" )%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
