<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CreateServiceExcessivePage.aspx.cs"
    Inherits="PMS.PMS.Maintain.CreateServiceExcessivePage" %>
...
<body onload="onLoad()" style="overflow: scroll; overflow-x: hidden">
    ...
    <iframe id="IFrameCreatPage" src="CreateService.aspx?Action=ADD" scrolling="no" frameborder="0">
    </iframe>
    </form>
</body>
</html>
