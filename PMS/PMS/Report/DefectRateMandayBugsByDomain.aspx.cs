...
{
    public partial class DefectRateMandayBugsByDomain : System.Web.UI.Page
    {
        #region Page_Load
        ...
        {
            string reportPath = ConfigurationManager.AppSettings["SSRS_ReportPath_Fold"] + "DefectRateMandayBugsByDomainAll";
            if (DropDownListDomain.SelectedValue.Trim() == "BACH")
            {
                reportPath = ConfigurationManager.AppSettings["SSRS_ReportPath_Fold"] + "DefectRateMandayBugsByDomainBACH";
            }
            else if (DropDownListDomain.SelectedValue.Trim() == "CIM")
            {
                reportPath = ConfigurationManager.AppSettings["SSRS_ReportPath_Fold"] + "DefectRateMandayBugsByDomainCIM";
            }
            else if (DropDownListDomain.SelectedValue.Trim() == "IP")
            {
                reportPath = ConfigurationManager.AppSettings["SSRS_ReportPath_Fold"] + "DefectRateMandayBugsByDomainIP";
            }
