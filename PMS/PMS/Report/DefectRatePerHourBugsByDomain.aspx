<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DefectRatePerHourBugsByDomain.aspx.cs"
    Inherits="PMS.PMS.Report.DefectRatePerHourBugsByDomain" %>
...
<head id="Head1" runat="server">
    <title>Defect Rate Per Hour Bugs By Domain</title>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function CheckBoxByAIC0OnClientClick() {
            
            var dropDownList = document.getElementById("<%=DropDownListDomain.ClientID %>");
            var checkBox = document.getElementById("<%=CheckBoxByAIC0.ClientID %>");
...
<body>
    ...
    <div style="margin: 10px; width: 1000px;">
        <div>
            ...
            <asp:Label ID="LabelBlank2" runat="server" Text="" Width="123px" />
            <asp:Label ID="LabelByAIC0" runat="server" Text="By AIC0 :" Width="130px" Visible="false" />
            <asp:CheckBox ID="CheckBoxByAIC0" runat="server" CssClass="DropDownList" onclick="CheckBoxByAIC0OnClientClick()"
                Visible="false" />
            <br />
            <br />
