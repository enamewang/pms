<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectCommitmentHitRate.aspx.cs"
    Inherits="PMS.PMS.Report.ProjectCommitmentHitRate" %>
...
<head id="Head1" runat="server">
    <title>Project Commitment Hit Rate</title>
...
<body>
    ...
    <div style="margin: 10px; width: 1000px;">
        <div>
            <asp:Label ID="LabelStatisticsInterval" runat="server" Text="Statistics Interval:"
                Width="130px" />
            <asp:DropDownList ID="DropDownListStatisticsInterval" runat="server" Width="150px"
            ...
            <asp:CheckBox ID="CheckBoxDivisionByDept" runat="server" CssClass="DropDownList"
                onclick="CheckBoxDivisionByDeptOnClientClick()" />
            <br />
            <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="DropDownListStatisticsInterval"
                ErrorMessage="Statistics Interval can not be empty!" />
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="TextBoxYearMonthFrom"
                runat="server" ValidationExpression="^[1-2][0-9]{3}\/[0-9][0-9]$" Display="Dynamic"
            ...
            <br />
            <br />
            <asp:Label ID="labelInquiryBank" runat="server" Text="  " Width="507px"></asp:Label>
