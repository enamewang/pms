...
{
    public partial class DefectRateMandayBugsByProject : System.Web.UI.Page
    {
        #region Page_Load
        ...
        private string GetReportPath()
        {
            ...
            {
                reportPath = ConfigurationManager.AppSettings["SSRS_ReportPath_Fold"] + "DefectRateMandayBugsByProjectAll";
            }
            else if (DropDownListUserDept.SelectedValue.Trim() != string.Empty && DropDownListRDDept.SelectedValue.Trim() == string.Empty)
            {
                reportPath = ConfigurationManager.AppSettings["SSRS_ReportPath_Fold"] + "DefectRateMandayBugsByProjectUserDept";
            }
            else if (DropDownListUserDept.SelectedValue.Trim() == string.Empty && DropDownListRDDept.SelectedValue.Trim() != string.Empty)
            {
                reportPath = ConfigurationManager.AppSettings["SSRS_ReportPath_Fold"] + "DefectRateMandayBugsByProjectRDDept";
            }
            else if (DropDownListUserDept.SelectedValue.Trim() == string.Empty && DropDownListRDDept.SelectedValue.Trim() == string.Empty)
            {
                reportPath = ConfigurationManager.AppSettings["SSRS_ReportPath_Fold"] + "DefectRateMandayBugsByProject";
            }
