<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectVarianceTrace.aspx.cs"
    Inherits="PMS.PMS.Report.ProjectVarianceTrace" %>
...
<head id="Head1" runat="server">
    <title>Project Variance Trace</title>
...
<body>
    ...
    <div style="margin: 10px; width: 1000px;">
        <div>
            <asp:Label ID="LabelCRNo" runat="server" Text="CR No. :" Width="130px" />
            <asp:TextBox ID="TextBoxCrNo" runat="server" Width="142px" />
            <br />
            <br />
            ...
            <asp:Label ID="Label22" runat="server" Text="" Width="40px" />
            ...
            <br />
            <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBoxCRNo"
                ErrorMessage="CR No. can not be empty!" />
