<%@ Page Language="C#" AutoEventWireup="true" Inherits="SysFrame_SecurityController_WSC_Role_User" Codebehind="WSC_Role_User.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml" >
<head runat="server">
   <title>Role-User Security</title>
    ...
    <form id="RoleUser" runat="server">
            ...
            <table border="0" style="width: 760px">
                ...
                <tr>
                    ...
                    <td style="height: 26px; width: 710px;">
                        <asp:Label ID="lblTitle" runat="server" Font-Bold="True" Font-Size="11pt" ForeColor="SteelBlue"
                            Text="Security-->Role-User setup" Width="280px"></asp:Label></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="font-size: 1pt; width: 710px;">
                        <table background="../images/n1.gif" style="width: 322px; height: 15px">
                            <tr>
                                <td style="width: 100px; height: 15px">
                                    <asp:Label ID="lblDispStyle" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                                        Font-Size="9pt" ForeColor="Blue" Height="15px" Text=" Display style" Width="78px"></asp:Label></td>
                ...
                <tr>
                    ...
                    <td style="font-size: 1pt; width: 710px;">
                        <table style="width: 716px" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="width: 75px; height: 15px" background="../images/bgcolor.gif">
                                    <asp:DropDownList ID="ddlDept" runat="server" Font-Size="9pt" Width="80px" AutoPostBack="True" OnSelectedIndexChanged="ddlDept_SelectedIndexChanged" CssClass="DropDownList">
                                    </asp:DropDownList></td>
                                <td style="width: 70px; height: 15px" background="../images/bgcolor.gif">
                                    <asp:Label ID="lblUserName" runat="server" Font-Size="9pt" Height="15px" Text="User Name"
                                        Width="70px"></asp:Label></td>
                                <td style="width: 102px; height: 15px" background="../images/bgcolor.gif">
                                    <asp:DropDownList ID="ddlUser" runat="server" Font-Size="9pt" Width="135px" CssClass="DropDownList">
                                    </asp:DropDownList></td>
                ...
                <tr>
                    ...
                    <td style="font-size: 1pt; background-image: url(../images/shadow.gif); height: 2px; width: 710px;">
                    </td>
                </tr>
                <tr>
                    ...
                    <td align="left" style="font-size: 1pt; width: 710px;">
                        <table align="left" style="width: 98%">
                            ...
                            <tr>
                                ...
                                <td style="font-size: 1pt; width: 667px;">
                                    &nbsp;<table cellpadding="0" cellspacing="0" style="width: 500px; height: 86px">
                                        <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="1" rowspan="3">
                                                            <asp:TreeView ID="Tree1" runat="server" Font-Names="宋体" Font-Size="9pt" ImageSet="Arrows"
                                                                ...
                                                                <LeafNodeStyle CssClass="TreeNodeLeaf" Font-Size="9pt" ForeColor="DimGray" ImageUrl="../images/WSC_User.gif" />
